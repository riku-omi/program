...
for n in tqdm(range(20)):
    ...
    lr=LogisticRegression(C=1.19,max_iter=156)

    usbc = BalancedBaggingClassifier(base_estimator=lr, n_jobs=-1, n_estimators=10,sampling_strategy='not minority')
    ...
    #imp = pd.DataFrame(permutation_importance(lr,X_train,y_train))
    #to=to+imp
    #average=to/20
...
#print(importance)
#importance.to_csv('/Users/namboriku/Desktop/卒業研究/lr_imp_cad.csv') 
...
#
#print(imp_sort)
#imp_sort.to_csv('/Users/namboriku/Desktop/卒業研究/lr_pimp_all2.csv') 
