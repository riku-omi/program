...
for n in tqdm(range(20)):
    ...
    Test_x,x_valid,Test_y,y_valid=train_test_split(X1,Y1,test_size=0.05,stratify=Y1)

    xgb=XGBClassifier(n_estimators=380,max_depth=33,max_delta_step=660)                   


    usbc = BalancedBaggingClassifier(base_estimator=xgb, n_jobs=-1, n_estimators=10,sampling_strategy='not minority')
...
#print(importance)
#importance.to_csv('/Users/namboriku/Desktop/卒業研究/xgb_imp_all.csv') 
...
print(imp_sort)
imp_sort.to_csv('/Users/namboriku/Desktop/卒業研究/xgb_pimp_all2.csv') 
"""
